...
<body style="background: #F9F9F9;">
    <div style="background-color:#F9F9F9;">
                                        ...
                                        <tr>
                                            <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                                                <table role="presentation" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><a href="http://psychiatryrounds.in"
                                                                    target="_blank"><img alt="logo" title="Logo"
                                                                        height="38px"
                                                                        src="https://psychiatryrounds.in/logo-full.png"
        ...
        <div
            ...
            <div
                style="margin:0px auto;max-width:640px;background:#B6CC37 url(https://cdn.discordapp.com/email_assets/f0a4cc6d7aaa7bdf2a3c15a193c6d224.png) top center / cover no-repeat;">
                <table role="presentation" cellpadding="0" cellspacing="0"
                    style="font-size:0px;width:100%;background:#B6CC37 url(https://cdn.discordapp.com/email_assets/f0a4cc6d7aaa7bdf2a3c15a193c6d224.png) top center / cover no-repeat;"
                        ...
                        <tr>
                            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:57px;">
                                <div
                                    ...
                                    Welcome to Psychiatry Rounds!</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                                ...
                                                <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;"
                                                    ...
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            <img src="https://psychiatryrounds.in/welcome.png"
                                                                alt="Party Wumpus" title="None" width="250"
                                                                style="height: auto;">
                                                        </p>
                                        ...
                                        <tr>
                                            <td style="word-break:break-word;font-size:0px;padding:0px;"
                                                ...
                                                <div
                                                    ...
                                                    Sent by PSY • <a href="https://blog.psychiatryrounds.in/"
                                                        style="color:#1EB0F4;text-decoration:none;"
                                                        target="_blank">check our blog</a> • <a
                                                        href="https://psychiatryrounds.in/"
                                                        style="color:#1EB0F4;text-decoration:none;"
                                                        target="_blank">@psyapp</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
